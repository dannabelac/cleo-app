  ...
  return e("div",{style:{fontFamily:'Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif',minHeight:"100vh",display:"flex",background:C.bg}},
    ...
    e("div",{style:{display:"flex",width:"100%"}},
              ...
              pedidosFiltrados.map(function(ped){
                ...
                return e("div",{key:ped.id,style:{background:C.surface,borderRadius:14,border:"1px solid "+C.border,padding:isMobile?"12px 14px":"16px 18px",boxShadow:"0 1px 4px rgba(0,0,0,0.04)",opacity:esCancelado?0.65:1,borderLeft:"3px solid "+bordeColor}},
                  ...
                  !esCancelado&&e("div",{style:{borderTop:"1px solid "+C.border+"44",paddingTop:8}},
                    ...
                    // Acción principal — full width en móvil, compacto en desktop
      ...
      vista==="resumen"&&esProductos&&(function(){
        ...
        var ritmoDiario=diaHoy>0?mesActual.total/diaHoy:0;
        var diasEnMesActual=diasEnMes(mesActual.mes,mesActual.anio);
        var proyeccionMes=Math.round(ritmoDiario*diasEnMesActual);
        ...
        return e("div",{style:{display:"flex",flexDirection:"column",gap:0}},
          ...
          e("div",{style:{background:C.surface,borderRadius:20,padding:isMobile?"16px":"24px",border:"1px solid "+C.border}},
            ...
            suficienteData&&mesActual.total>0&&e("div",{style:{fontSize:isMobile?13:14,color:C.textMuted,marginBottom:16,lineHeight:1.4}},
              "A este ritmo, "+MESES_LARGO[mesActual.mes]+" cierra en ",
              e("span",{style:{fontWeight:700,color:C.purple}},"$"+proyeccionMes.toLocaleString())
            ),
            !suficienteData&&e("div",{style:{fontSize:12,color:C.textDim,marginBottom:16,lineHeight:1.4}},"Apenas comienza "+MESES_LARGO[mesActual.mes]+" , en unos días verás tu proyección."),
            suficienteData&&mesActual.total===0&&e("div",{style:{fontSize:12,color:C.textDim,marginBottom:16,lineHeight:1.4}},"Aún no registras ingresos en "+MESES_LARGO[mesActual.mes]+". En cuanto llegue el primero, verás tu ritmo aquí."),
